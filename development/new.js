...
if (!disabledButtonExists) {
    await page.click("a.s-pagination-item.s-pagination-next.s-pagination-button.s-pagination-button-accessibility.s-pagination-separator")
    console.log(items);
}
    ...
    for (const producthandle of productHandles) {
        ...
        console.log(items.length);
    } await page.waitForSelector("a.s-pagination-item.s-pagination-next.s-pagination-button.s-pagination-button-accessibility.s-pagination-separator", { visible: true });
    
    // "Schau nach, ob ein Element mit diesen Klassen im HTML existiert – wenn ja, dann setze isDisabled auf true, wenn nein, auf false
    // Wenn das Ergebnis !== null ist, dann gib uns true aus 
    const disabledButtonExists2 = await page.$('span.s-pagination-item.s-pagination-next.s-pagination-disabled') !== null;
    
    if (!disabledButtonExists2) {
        await page.click("a.s-pagination-item.s-pagination-next.s-pagination-button.s-pagination-button-accessibility.s-pagination-separator")
        console.log(items);
    }
